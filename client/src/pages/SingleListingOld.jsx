    ...
    async function fetchData() {
      try {
        const [listingRes, meRes] = await Promise.all([
          ...
          API.get(`/users/current-user`, { withCredentials: true }),
        ]);
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {listing.reviews?.map((r) => (
                <div key={r._id} className="border rounded-xl p-4 bg-gray-50">
                  <p className="font-semibold">@{r.author?.username}</p>
